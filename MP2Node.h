...
private:
    ...
    struct TransactionInfo {
        ...
        bool isFailed = false;
        MessageType opType;  // Enum for operation type: CREATE, READ, UPDATE, DELETE
        string key;
        string value;  // For CREATE and UPDATE operations
    };

    map<int, TransactionInfo> transactionStatus;
